...
public class Professor extends Teacher implements Researcher{
    ...
    public Professor(String firstName, String lastName, String login, String password,double salary, String department, String position, LocalDate hiringDate) {
    super(firstName, lastName, login, password, salary, department, position, hiringDate, TeacherPosition.PROFESSOR);
    this.hIndex = 0;
    }
